...
public:
	...
	void		LevelUpPlayer()
	{
		this->pcProfile->avatarAttribute.wLastPhysicalOffence += (WORD)this->byLevel_Up_Physical_Offence;
		this->pcProfile->avatarAttribute.wLastPhysicalDefence += (WORD)this->byLevel_Up_Physical_Defence;
		this->pcProfile->avatarAttribute.wLastEnergyOffence += (WORD)this->byLevel_Up_Energy_Offence;
		this->pcProfile->avatarAttribute.wLastEnergyDefence += (WORD)this->byLevel_Up_Energy_Defence;
		this->pcProfile->avatarAttribute.byLastCon += (BYTE)this->fLevel_Up_Con;
		this->pcProfile->avatarAttribute.byLastDex += (BYTE)this->fLevel_Up_Dex;
		this->pcProfile->avatarAttribute.byLastEng += (BYTE)this->fLevel_Up_Eng;
		this->pcProfile->avatarAttribute.byLastFoc += (BYTE)this->fLevel_Up_Foc;
		this->pcProfile->avatarAttribute.byLastSol += (BYTE)this->fLevel_Up_Sol;
		this->pcProfile->avatarAttribute.byLastStr += (BYTE)this->fLevel_Up_Str;
		this->pcProfile->avatarAttribute.wLastMaxRP += (WORD)this->byLevel_Up_RP;
		this->pcProfile->avatarAttribute.wLastMaxEP = (WORD)(this->pcProfile->avatarAttribute.wBaseMaxEP + this->byLevel_Up_EP);
		this->pcProfile->avatarAttribute.wLastMaxEP = this->pcProfile->avatarAttribute.wBaseMaxEP + (WORD)(this->pcProfile->avatarAttribute.byLastEng * 4.2);
		this->pcProfile->avatarAttribute.wLastMaxLP = (this->pcProfile->avatarAttribute.wBaseMaxLP + (WORD)this->byLevel_Up_LP);
		this->pcProfile->avatarAttribute.wLastMaxLP = this->pcProfile->avatarAttribute.wBaseMaxLP + (WORD)(this->pcProfile->avatarAttribute.byLastCon* 4.7);
		if (this->pcProfile->byLevel == 5)
			this->CurRPBall = 1;
