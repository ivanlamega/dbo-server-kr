...
void		PlayerInfos::FillProfileAttributes()
{
	PlayerAttributes* cPlayerAtts;
	cPlayerAtts->LoadAttributesFromDB(this->pcProfile->charId);
	this->pcProfile->avatarAttribute = cPlayerAtts->GetAvatarAttribute();
	//this->cPlayerAttributes->LoadAttributesFromDB(this->pcProfile->charId);
	//this->pcProfile->avatarAttribute = this->cPlayerAttributes->GetAvatarAttribute();
}
